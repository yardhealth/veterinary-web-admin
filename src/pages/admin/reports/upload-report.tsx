...
import AddLabReport from 'components/admin/reports/AddReport'
import AddReport from 'components/admin/reports/AddReport'
...
const UploadReport = () => {
  ...
  return (
    <AdminLayout title="Create Lab Report">
      <Container
        maxWidth="xl"
        // style={{
        //   width: '40vw',
